...
#MESS WITH ANSWER4
Question.create(prompt: "How can you detect the client's browser name?", answer1: "navigator.appName", answer2: "browser.name", answer3: "client.navName", answer4: "MESS WITH THIS ONE", correct_answer: "navigator.appName", subject_id: java_script.id)
#MAYBE NOT THE BEST QUESTION TO HAVE ON A DIFF QUIZ WEBSITE
Question.create(prompt: 'What is the correct JavaScript syntax for opening a new window called "w2"?', answer1: 'w2 = window.new("http://www.w3schools.com");', answer2: 'w2 = window.open("http://www.w3schools.com");', answer3: 'w2 = window.create("http://www.w3schools.com");', answer4: 'w2 = window.code("http://www.w3schools.com");', correct_answer: 'w2 = window.open("http://www.w3schools.com");', subject_id: java_script.id)
# Question.create()
# Question.create
# Question.create
# HTML
...
# MAYBE CHANGE ANSWER 4 OF THIS ONE

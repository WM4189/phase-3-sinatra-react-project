...
Question.create(prompt: "How do you call a function named 'myFunction'?", answer1: "call myFunction()" , answer2: "myFunction()", answer3: "call function myFunction()", answer4: "None of the answers are correct", correct_answer: "myFunction()", subject_id: java_script.id)
...
Question.create(prompt: "How can you open a link in a new tab/browser window?" answer1: '<a href="url" target="new">', answer2:'<a href="url" target="_blank"> ', answer3: '<a href="url" new>', answer4: '<a href="/" target="new">', correct_answer: '<a href="url" target="_blank">' , subject_id: html.id)

Question.create(prompt: 'Which of these elements are all <table> elements?', answer1: '<table><tr><td>', answer2: '<table><head><tfoot>', answer3: '<table><tr><tt>', answer4: '<thead><body><tr>' correct_answer: '<table><tr><td>', subject_id: html.id)
...
Question.create(prompt: "What is the correct CSS syntax for making all the <p> elements bold?", answer1: '<p style="font-size:bold;">', answer2: '<p style="text-size:bold;">', answer3: "p {font-weight:bold;}", answer4: "p {text-size:bold;}", correct_answer: "p{font-weight:bold;}" subject_id: css.id)
...
## python
Question.create(prompt: "What is the correct file extension for Python files?", answer1: ".py", answer2: ".pyt", answer3: ".pyth", answer4: ".pt", correct_answer: ".py", subject_id: python.id)
Question.create(prompt: "What is the correct syntax to output the type of a variable or object in Python?", answer1: "print(type(x))", answer2: "print(typeof(x))", answer3: "print(typeOf(x))", answer4: "print(typeof x)", correct_answer: "print(type(x))", subject_id: python.id)
...
Question.create(prompt: "Which of these collections defines a LIST?", answer1: '{"name": "apple", "color": "green"}', answer2: '{"apple", "banana", "cherry"}', answer3: '("apple", "banana", "cherry")'
answer4: '["apple", "banana", "cherry"]' correct_answer: '["apple", "banana", "cherry"]', subject_id: python.id)
Question.create(prompt: "Which of these collections defines a TUPLE?", answer1: '{"apple", "banana", "cherry"}', answer2: '("apple", "banana", "cherry")', answer3: '{"name": "apple", "color": "green"}', answer4: '["apple", "banana", "cherry"]', correct_answer: '("apple", "banana", "cherry")', subject_id: python.id)
...
Question.create(prompt: "Which of these collections defnies a DICTIONARY?", answer1: '{"name": "apple", "color": "green"}', answer2: '["apple", "banana", "cherry"]', answer3: '{"apple", "banana", "cherry"}', answer4: '("apple", "banana", "cherry")', correct_answer:'{"name": "apple", "color": "green"}' subject_id: python.id)
...
Question.create(prompt: 'With SQL, how do you select all the records from a table named "Persons" where the value of the column "FirstName" starts with an "a"?', answer1: "SELECT * FROM Persons WHERE FirstName='a'", answer2: "SELECT * FROM Persons WHERE FirstName LIKE 'a%'", answer3: "SELECT * FROM Persons WHERE FirstName LIKE '%a'", answer4: "SELECT * FROM Persons WHERE FirstName='%a%'", correct_answer: "SELECT * FROM Persons WHERE FirstName LIKE 'a%'", subject_id: sql.id)
Question.create(prompt: 'With SQL, how can you return all the records from a table named "Persons" sorted descending by "FirstName"?', answer1: 'SELECT * FROM Persons ORDER BY FirstName DESC', answer2: "SELECT * FROM Persons SORT BY 'FirstName' DESC", answer3: "SELECT * FROM Persons ORDER FirstName DESC", answer4: "SELECT * FROM Persons SORT 'FirstName' DESC", correct_answer: "SELECT * FROM Persons ORDER BY FirstName DESC", subject_id: sql.id)
Question.create(prompt: "What does SQL stand for?", answer1: "Structured Query Language", answer2: "Structured Question Language", answer3: "Strong Question Language", answer4: "Strong Query Language", correct_answer: "Structured Query Language  ", subject_id: sql.id)
...
Question.create(prompt: "Which SQL statement is used to delete data from a database?", answer1: "COLLAPSE", answer2: "REMOVE", answer3: "DELETE", answer4: "CUT", correct_answer: "DELETE", subject_id: sql.id)
Question.create(prompt:'With SQL, how do you select all the records from a table named "Persons" where the "FirstName" is "Peter" and the "LastName" is "Jackson"?', answer1: "SELECT * FROM Persons WHERE FirstName='Peter' AND LastName='Jackson'", answer2: "SELECT * FROM Persons WHERE FirstName<>'Peter' AND LastName<>'Jackson'", answer3: "SELECT FirstName='Peter', LastName='Jackson' FROM Persons", answer4: "None of the above", correct_answer: "SELECT * FROM Persons WHERE FirstName='Peter' AND LastName='Jackson'  ", subject_id: sql.id )
...
Question.create(prompt: "How do you create a variable with the floating number 2.8?", answer1: 'int x = 2.8f;', answer2: 'byte x = 2.8f', answer3: 'x = 2.8f;', answer4: 'float x = 2.8f;', correct_answer: 'float x = 2.8f;', subject_id: java.id)
...
Question.create(prompt: "Which method can be used to find the highest value of x and y?", answer1: "Math.max(x,y)", answer2: "Math.largest(x,y)", answer3: "Math.maxNum(x,y)", answer4: "Math.maximum(x,y)", correct_answer: "Math.max(x,y)" subject_id: java.id)
...
#c++
Question.create(prompt: 'What is a correct syntax to output "Hello World" in C++?', answer1: 'print ("Hello World");', answer2: 'System.out.println("Hello World");
', answer3: 'Console.WriteLine("Hello World");', answer4: 'cout << "Hello World";', correct_answer: 'cout << "Hello World";', subject_id: c.id)
Question.create(prompt: "How do you create a variable with the floating number 2.8?", answer1: "double x = 2.8;", answer2: "int x = 2.8;", answer3: "x = 2.8;", answer4: "byte x = 2.8", correct_answer: "double x = 2.8;", subject_id: c.id)
...
Question.create(prompt: "Which header file lets us work with input and output objects?", answer1: "#include <iosstring>", answer2: "#include <iostream>", answer3: "#include <stream>" ,answer4: "#include <inputstr>", correct_answer: "#include <iostream>", subject_id: c.id)
